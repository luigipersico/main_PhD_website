...
by the [NBI-1 of TCV](TCV_NBI.qmd). Along the beam 20 LOS are defined, originating from the optical
setup at the bottom of TCV, as shown in @fig-LOS_TCV.

::: {#fig-LOS_TCV layout-ncol="2"}
![Intersection of LOS (in grey) with the NBI (in orange) @sacha2025thesis.](Figures/LOS_TCV1.jpg){#fig-LOS_TCV1 width=70%}

![Poloidal cross section of TCV with an example of magnetic equilibrium. In red the LOS and in green the NBI @sacha2025thesis.](Figures/LOS_TCV2.png){#fig-LOS_TCV2 width=30%}
